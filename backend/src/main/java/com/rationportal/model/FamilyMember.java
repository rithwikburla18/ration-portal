...
public class FamilyMember {
    ...
    @Column(name = "rice_quota_kg", nullable = false)
    private BigDecimal riceQuotaKg;
    ...
    public BigDecimal getRiceQuotaKg() {
        return riceQuotaKg;
    }

    public void setRiceQuotaKg(BigDecimal riceQuotaKg) {
        this.riceQuotaKg = riceQuotaKg;
    }
}
